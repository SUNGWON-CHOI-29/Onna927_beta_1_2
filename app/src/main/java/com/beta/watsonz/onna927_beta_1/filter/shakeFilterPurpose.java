 ...
 */
public class shakeFilterPurpose extends Activity {
    public static final String TEXT_RESULT = "TextResult";

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_filterpurpose);
        ...
        final Button bt_seven = (Button)findViewById(R.id.btSeven);
        bt_seven.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String result = bt_seven.getText().toString();
                Intent i = new Intent();
                i.putExtra(TEXT_RESULT,result);
                setResult(RESULT_OK, i);
